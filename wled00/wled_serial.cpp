...
// Optional usermod hook. The pairing code is returned only in response to an
// explicit physical USB/UART request, never in logs or unauthenticated radio data.
uint32_t wledBluetoothPairingCode() __attribute__((weak));
// AI: end
  ...
  while (Serial.available() > 0)
  {
    ...
    switch (state) {
      case AdaState::Header_A:
        ...
        // AI: below section was generated by an AI
        else if (next == 'B' && serialCanTX && wledBluetoothPairingCode) {
          Serial.printf("{\"ble\":{\"pairingCode\":\"%06lu\"}}\n", static_cast<unsigned long>(wledBluetoothPairingCode()));
        }
        // AI: end
